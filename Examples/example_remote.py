"""Remote connection sensor visualization example, required pip install xensesdk[viz]。"""
...
def main() -> None:
    ...
    # Replace master_service with the actual service name, usually in the format "master_{mac_address}"，
    # --------------------
