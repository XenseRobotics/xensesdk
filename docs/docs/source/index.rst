      ...
      <div class="relative z-10 container mx-auto px-4 py-16 md:py-24 flex flex-col items-center justify-center min-h-screen">
         ...
         <header class="text-center mb-16 md:mb-24">
               <h1 class="text-[clamp(2.5rem,6vw,4.5rem)] font-display font-bold leading-tight mb-4">
                  <span class="bg-gradient-to-r from-primary to-accent text-gradient">Xense Robot</span> 
               </h1>
               <p class="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto">
                  Explore our Software Development Kit to easily integrate powerful features into your application
               </p>
         </header>
         ...
         <div class="grid grid-cols-2 gap-6 md:gap-8 justify-items-center w-full max-w-4xl">
            <!-- XenseStudio 按钮 -->
            <a href="https://xensesdk-cn.readthedocs.io/en/latest/XenseStudio/Introduction.html" target="_blank" class="btn-hover btn-custom rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-700 flex flex-col items-center justify-center p-4 shadow-2xl border border-purple-500/30 group">
               ...
               <p class="text-center text-white/80 text-xs">Usage Document</p>
               <span class="mt-2 inline-block bg-white/20 text-white text-xs px-2 py-0.5 rounded-full backdrop-blur-sm">
                  Check <i class="fa fa-external-link ml-1 group-hover:translate-x-1 transition-transform"></i>
               </span>
            </a>

            <!-- XenseSDK 按钮 -->
            <a href="https://xensesdk-cn.readthedocs.io/en/latest/XenseSDK/XenseSDK.html" target="_blank" class="btn-hover btn-custom rounded-2xl bg-gradient-to-br from-primary to-blue-700 flex flex-col items-center justify-center p-4 shadow-2xl border border-primary/30 group">
               <div class="w-12 h-12 mb-3 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm transition-transform duration-300 group-hover:rotate-12">
                  <i class="fa fa-microchip text-white text-xl"></i>
               </div>
               <h2 class="text-xl md:text-2xl font-bold mb-1 text-white">XenseSDK</h2>
               <p class="text-center text-white/80 text-xs">Software Development Kit</p>
               <span class="mt-2 inline-block bg-white/20 text-white text-xs px-2 py-0.5 rounded-full backdrop-blur-sm">
                  Check <i class="fa fa-external-link ml-1 group-hover:translate-x-1 transition-transform"></i>
               </span>
            </a>
            ...
            <!-- GripperSDK 按钮 -->
            <a href="https://xensesdk-cn.readthedocs.io/en/latest/GripperSDK/GripperSDK.html" target="_blank" class="btn-hover btn-custom rounded-2xl bg-gradient-to-br from-secondary to-emerald-700 flex flex-col items-center justify-center p-4 shadow-2xl border border-secondary/30 group">
               <div class="w-12 h-12 mb-3 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm transition-transform duration-300 group-hover:-rotate-12">
            ...
            <!-- Hardware 按钮 -->
            <a href="https://xensesdk-cn.readthedocs.io/en/latest/Hardware/Hardware.html" target="_blank" class="btn-hover btn-custom rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex flex-col items-center justify-center p-4 shadow-2xl border border-amber-500/30 group">
               <div class="w-12 h-12 mb-3 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm transition-transform duration-300 group-hover:rotate-12">
                  <i class="fa fa-microchip text-white text-xl"></i> 
               </div>
               <h2 class="text-xl md:text-2xl font-bold mb-1 text-white">Hardware</h2>
               <p class="text-center text-white/80 text-xs">Hardware Documentation</p> 
               <span class="mt-2 inline-block bg-white/20 text-white text-xs px-2 py-0.5 rounded-full backdrop-blur-sm">
                  Check <i class="fa fa-external-link ml-1 group-hover:translate-x-1 transition-transform"></i>
               </span>
            </a>
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 w-full max-w-5xl">
               <div class="bg-glass rounded-xl p-6 border border-white/10 hover:border-primary/50 transition-colors duration-300">
                  ...
                  <h3 class="text-xl font-semibold mb-2">Simple Integration</h3>
                  <p class="text-slate-300 text-sm">We provide a concise API that integrates easily into your existing projects, reducing development time</p>
               </div>
               ...
               <div class="bg-glass rounded-xl p-6 border border-white/10 hover:border-accent/50 transition-colors duration-300">
                  ...
                  <h3 class="text-xl font-semibold mb-2">Improve the Documentation</h3>
                  <p class="text-slate-300 text-sm">Detailed usage instructions and sample code accelerate the development process</p>
               </div>
               ...
               <div class="bg-glass rounded-xl p-6 border border-white/10 hover:border-secondary/50 transition-colors duration-300">
                  ...
                  <p class="text-slate-300 text-sm">A professional team provides technical support to resolve issues during the integration process</p>
               </div>
         </div>
